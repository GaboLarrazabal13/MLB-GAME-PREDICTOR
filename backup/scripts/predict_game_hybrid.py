"""
Script de Predicción de Partidos MLB - MODELO HÍBRIDO
Usa el modelo híbrido entrenado (features temporales + scraping)
"""
...
# ============================================================================
# FUNCIONES PARA FEATURES TEMPORALES (SIMULADAS PARA PREDICCIÓN EN VIVO)
# ============================================================================
...
def predecir_partido(home_team, away_team, home_pitcher, away_pitcher, year=2026):
    """
    Predice el resultado de un partido usando el modelo híbrido
    ...
    print("\n" + "="*70)
    print(" PREDICTOR DE PARTIDOS MLB - MODELO HÍBRIDO")
    print("="*70)
    ...
    try:
        print("\n📦 Cargando modelo híbrido entrenado...")
        ...
        print("\n❌ Error: No se encontró el modelo híbrido entrenado.")
        print("   Primero ejecuta: python train_model_hybrid_optimized.py")
        return None

    # Extraer datos actualizados - INTENTAR MÚLTIPLES AÑOS
    print("\n" + "="*70)
    print(" EXTRAYENDO DATOS ACTUALIZADOS")
    print("="*70)
    ...
    if pitcher1_stats is None:
        ...
        print("   ℹ️  Usando stats promedio del equipo como fallback")
    ...
    print("\n📈 Usando features temporales promedio para predicción en vivo...")
    features_temporales = simular_features_temporales()
    features.update(features_temporales)

    # Features de scraping (del equipo)
    ...
    print("   ℹ️  Features temporales: valores promedio (sin historial del partido)")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 5:
        ...
        if home_code and away_code:
            ...
            print("   Usa: python predict_game_hybrid.py --equipos  para ver la lista completa")
    ...
    # Ayuda
        ...
        print("\n" + "="*70)
        print(" PREDICTOR DE PARTIDOS MLB - Ayuda (MODELO HÍBRIDO)")
        print("="*70)
        print("\n📖 USO:")
        print("\n1. Modo línea de comandos:")
        print("   python predict_game_hybrid.py <equipo_local> <equipo_visitante> <lanzador_local> <lanzador_visitante>")
        print("\n   Ejemplos:")
        print("   python predict_game_hybrid.py NYY BOS Cole Bello")
        print("   python predict_game_hybrid.py \"New York Yankees\" \"Boston Red Sox\" Cole Bello")
        print("   python predict_game_hybrid.py Yankees \"Red Sox\" Cole Bello")
        print("\n2. Modo interactivo:")
        print("   python predict_game_hybrid.py")
        print("\n3. Ver lista de equipos:")
        print("   python predict_game_hybrid.py --equipos")
        print("\n" + "="*70)
        print("\n💡 FORMATO DE EQUIPOS:")
    ...
    # Modo interactivo
        ...
        if len(sys.argv) > 1:
            ...
            print("   Usa: python predict_game_hybrid.py --help  para ver la ayuda")
            sys.exit(1)

        print("\n" + "="*70)
        print(" PREDICTOR DE PARTIDOS MLB - Modo Interactivo (MODELO HÍBRIDO)")
        print("="*70)
