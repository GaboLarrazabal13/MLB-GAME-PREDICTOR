...
def entrenar_modelo(csv_path='./data/processed/datos_ml_ready.csv', test_size=0.2,
    ...
    if usar_cache:
        try:
            ...
            print("   ⚠️  No se encontró cache, extrayendo features...")
            usar_cache = False
    ...
    print("   ✅ mlb_model.pkl")
    print("   ✅ mlb_scaler.pkl")
    print("   ✅ mlb_feature_names.pkl")
    print("   ✅ mlb_model_info.pkl")

    print("\n" + "="*70)
    print(" ✅ ENTRENAMIENTO COMPLETADO")
    print("="*70)
    print("\nAhora puedes usar el modelo para hacer predicciones:")
    print("   python predict_game.py BOS NYY Bello Cole")
